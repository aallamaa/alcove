...
test-all:
	...
	case "$$ires" in \
	  *" 7 failed") echo "  OK — $$ires (7 = the pinned tier-definitional set:"; \
	                echo "       5 jit/compiled? introspection asserts + 2 deep-try"; \
	  ...
	  *) echo "  BASELINE DRIFT — $$ires (expected exactly 7 failed)."; \
